...
const LINKS: Record<string, { label: string; to?: string; href?: string }[]> = {
  ...
  Legal: [
    ...
    { label: "Delete Account Request", to: "/delete-account-request" },
  ],
  Contact: [
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-3">
              ...
              >
                ...
                >
                  <path
                    d="M3.18 23.76c.3.17.65.19.96.07l12.45-7.2-2.55-2.55-10.86 9.68z"
                    fill="#EA4335"
                  />
                  <path
                    d="M2.05 2.96a1.5 1.5 0 0 0-.55 1.18v17.72c0 .47.2.89.55 1.18l.07.06 9.92-9.92v-.23L2.12 2.9l-.07.06z"
                    fill="#4285F4"
                  />
                  <path
                    d="M22.23 11.6l-2.63-1.52-2.83 2.83 2.83 2.83 2.65-1.53a1.5 1.5 0 0 0 0-2.61z"
                    fill="#FBBC05"
                  />
                  <path
                    d="M3.14 23.83l10.86-9.68-2.55-2.55L1.39 22.14l1.75 1.69z"
                    fill="#34A853"
                  />
                </svg>
                Google Play
